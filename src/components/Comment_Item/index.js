...
function CommentItem({ comment }) {
  return (
    <div className="border-solid border-b-[1px] mb-3">
      ...
      <div className="mb-3">{comment?.note}</div>
      ...
      <div className="flex mb-3">
        <FontAwesomeIcon
          icon={faThumbsUp}
          className="h-[20px] w-[20px] text-gray-500 me-4 cursor-pointer"
        />
        {comment.like}
      </div>
      {comment.rep === false ? (
        ...
        <div className="mb-3 min-w-[300px] pt-5 ps-5 bg-gray-100 rounded-md p-2 border">
          ...
          <div className="mb-10">{comment.rep_detail.note}</div>
